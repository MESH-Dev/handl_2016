<?php
/**
 * Template Name: Post Object Test Template
...
get_header(); ?>
				...
				<?php 
					$related_attorney = get_field('attorneys_practicing');
					
					foreach ($related_attorney as $post){ 
					setup_postdata($post);
					?>
					<div class="attorney"><?php the_title();?></div>
					<?php } ?>
				<?php
