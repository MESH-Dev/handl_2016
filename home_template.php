...
get_header(); ?>
	...
	<?php while ( have_posts() ) : the_post(); ?>
        ...
        <div class=""><!--seven columns-->
    		<div id='' class='home-callout'><!-- home-callout -->
            
            	<h2><?=$custom_fields['Home-Callout'][0] ?> </h2>
    ...
    <!--	<div id='contact-us-now'>
    	...
    	<h2>contact us now</h2>
         ...
         <span style='font-size: 26px; font-weight: bold; margin-top: 10px;'><?php //$custom_fields['Telephone'][0] ?></span>
            
        <p style='margin-top: 10px;'>
        Fax: <strong><?php //$custom_fields['Fax'][0] ?></strong><br />
        Email us: <strong><a href="mailto:info@handl.com" ><?php //$custom_fields['Email'][0] ?></a></strong>
        </p>
            
        <p style='font-style: italic;'>
        	<?php //$custom_fields['Street-Address'][0] ?><br />
			<?php //$custom_fields['City-State-Zip'][0] ?>
      </p>
