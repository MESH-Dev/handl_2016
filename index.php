	                        ...
	                        <div class="row">
	                        	<div class="twelve columns">
			                        <div class='blog-social-media'>
			                            ...
			                            <span class="st_linkedin_custom" displaytext="LinkedIn" st_title='<?php the_title(); ?>' st_url='<?php the_permalink(); ?>'></span>						
			                            <span class='st_sharethis_custom' st_title='<?php the_title(); ?>' st_url='<?php the_permalink(); ?>'></span>
